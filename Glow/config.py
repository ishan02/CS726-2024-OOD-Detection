def get_config():
    return {
        ...
        "saved_model": "/kaggle/input/glow-conditioned-epoch10/pytorch/70/1/glow_checkpoint_70.pt",
        "saved_optimizer": "/kaggle/input/glow-conditioned-epoch10/pytorch/70/1/glow_checkpoint_70.pt",
        "seed":0
    }