def get_config():
    return {
        ...
        "saved_model": "/kaggle/input/glow-conditioned-epoch10/pytorch/35/1/glow_checkpoint_35.pt",
        "saved_optimizer": "/kaggle/input/glow-conditioned-epoch10/pytorch/35/1/glow_checkpoint_35.pt",
        "seed":0
    }